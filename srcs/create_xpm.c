...
/*   Updated: 2016/05/26 23:32:49 by vquesnel         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_texture	*create_xpm(t_env *env)
{
	...
	tex->text4 = mlx_xpm_file_to_image(env->mlx, "./textures/wall7.xpm", &width, &height);
	tex->tab4 = (int *)mlx_get_data_addr(tex->text4, &tex->bpp, &tex->sizeline, &tex->endian);
	tex->textsol = mlx_xpm_file_to_image(env->mlx, "./textures/floor3.xpm", &width, &height);
	tex->sol = (int*)mlx_get_data_addr(tex->textsol, &tex->bpp, &tex->sizeline, &tex->endian);
	tex->textroof = mlx_xpm_file_to_image(env->mlx, "./textures/ceil2.xpm", &width, &height);
